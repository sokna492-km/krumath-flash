...
## This app: KruMath Flash

| Item | Value |
| ---- | ----- |
| Slug | `krumath-flash` |
| URL | `krumath.com/krumath-flash` |
| Gate | **Soft** — Stats only (play is open; anonymous/unsigned blocked from Stats) |
| Worker name (suggested) | `krumath-flash` |

Operator steps and smoke tests: see [DEPLOY.md](./DEPLOY.md).
